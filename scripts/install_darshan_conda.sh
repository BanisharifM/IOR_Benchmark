...
# Darshan Installation Script for Conda Environment
# Downloads, compiles, and installs Darshan I/O profiling tool using conda dependencies

set -e

echo "=== Installing Darshan I/O Profiling Tool (Conda Version) ==="
...
# Darshan Configuration File for Conda Environment
...
# Update the environment activation script to include Darshan
echo "Updating environment activation script..."
cat >> "$HOME/ior-darshan-repo/activate_ior_env.sh" << 'EOF'
...
echo ""
echo "To use Darshan, make sure the conda environment is activated:"
echo "source ./activate_ior_env.sh"

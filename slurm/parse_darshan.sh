...
$PYTHON_BIN $PARSER_SCRIPT logs/tests/2025/6/30 data/darshan_csv/darshan_parsed_output_6-30-V3.csv

echo "✅ Darshan parsing complete, output → data/darshan_csv/darshan_parsed_output_6-30-V3.csv"

...
$PYTHON_BIN $PARSER_SCRIPT logs/tests/2025/7/1 data/darshan_csv/darshan_parsed_output_7-1-V2.csv

echo "✅ Darshan parsing complete, output → data/darshan_csv/darshan_parsed_output_7-1-V2.csv"

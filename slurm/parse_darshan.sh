...
$PYTHON_BIN $PARSER_SCRIPT logs/tests/2025/6/29 data/darshan_parsed_output_6-29.csv

echo "✅ Darshan parsing complete, output → data/darshan_parsed_output_6-29.csv"
